...
public:
	...
	void serialize(std::ostream &os) {
		...
		writeLine(os, "<MPD xmlns=\"urn:mpeg:dash:schema:mpd:2011\" minBufferTime=\"PT1.500000S\" type=\"static\" mediaPresentationDuration=\"%s\" profiles=\"urn:mpeg:dash:profile:full:2011\">", mediaPresentationDuration);
